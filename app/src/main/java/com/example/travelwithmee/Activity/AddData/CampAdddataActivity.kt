...
class CampAdddataActivity : AppCompatActivity() {
    lateinit var binding : ActivityCampAdddataBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityCampAdddataBinding.inflate(layoutInflater)
    ...
    private fun initview() {
        binding.btnbsubmit.setOnClickListener {
            ...
            var key = reference.root.child("CampDataTb").push().key ?:""

            var modelClass = CategoryModelclass(place,city,description,price,people,key,Imageuri,Like)

            reference.root.child("CampDataTb").child(key).setValue(modelClass).addOnCompleteListener {
    ...
    private fun uploadImage() {
        if (uri != null) {
            ...
            val ref: StorageReference = FirebaseStorage.getInstance().getReference()
                .child("images/Camp/" + UUID.randomUUID().toString())
